...
--
-- Host: localhost
-- Generation Time: Feb 11, 2014 at 02:50 AM
...
(103, 'Carine ', 'Schmitt', 'Carine ', '6575765756756756', '54, rue Royale', NULL, 'Nantes', NULL, '44000', 'Sweden', 1370, 90300),
(112, 'Signal Gift Stores', 'King', 'Jean', '7025551838', '8489 Strong St.', NULL, 'Las Vegas', 'NV', '83030', 'USA', 1166, 71800),
(114, 'Australian Collectors, Co.111', 'Ferguson', 'Peter', '03 9520 4555', '636 St Kilda Road', 'Level 3', 'Melbourne', 'Victoria', '3004', 'Australia', 1611, 117300),
(119, 'La Rochelle Gifts11', 'Labrune', 'Janine ', '40.67.8555', '67, rue des Cinquante Otages', NULL, 'Nantes', NULL, '44000', 'France', 1370, 3000),
...
(145, 'Jytte ', 'Petersen', 'Jytte ', '567657567657657', 'Vinbæltet 34', NULL, 'Kobenhavn', NULL, '1734', 'Portugal', 1401, 83400),
...
(186, 'Matti', 'Karttunen', 'Matti', '7876867867867', 'Keskuskatu 45', NULL, 'Helsinki', NULL, '21240', 'Japan', 1501, 96500),
...
(227, 'Palle2323', 'Ibsen', 'Palle', '456456456456', 'Smagsloget 45', NULL, 'Århus', NULL, '8200', 'Denmark', 1401, 120800),
...
(382, 'Salzburg Collectables', 'Pipps', 'Georg43445', '675765765757', 'Geislweg 14', NULL, 'Salzburg', NULL, '5020', 'Austria', 1401, 20000),
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  KEY `customerNumber_2` (`customerNumber`),
...
INSERT INTO `orders` (`orderNumber`, `orderDate`, `requiredDate`, `shippedDate`, `status`, `comments`, `customerNumber`, `files`) VALUES
(10100, '2003-01-06', '2003-01-13', '2003-01-10', 'Cancelled', NULL, 363, ''),
(10101, '2003-01-09', '2003-01-18', '2003-01-11', 'Shipped', 'Check on availability.', 128, ''),
(10102, '2003-01-10', '2003-01-18', '2003-01-14', 'Shipped', NULL, 181, ''),
(10103, '2003-01-29', '2003-02-07', '2003-02-02', 'In Process', NULL, 121, ''),
(10104, '2003-01-31', '2003-02-09', '2003-02-01', 'Shipped', NULL, 141, ''),
(10105, '2003-02-11', '2003-02-21', '2003-02-12', 'Shipped', NULL, 145, ''),
(10106, '2003-02-17', '2003-02-24', '2003-02-21', 'Disputed', NULL, 278, ''),
(10107, '2003-02-24', '2003-03-03', '2003-02-26', 'Disputed', 'Difficult to negotiate with customer. We need more marketing materials', 131, ''),
(10108, '2003-03-03', '2003-03-12', '2003-03-08', 'Cancelled', NULL, 385, ''),
...
(10123, '2003-05-20', '2003-05-29', '2003-05-22', 'Shipped', NULL, 103, 'Blue hills.jpg'),
...
(10278, '2004-08-06', '2004-08-16', '2004-08-09', 'Disputed', NULL, 112, ''),
...
(10298, '2004-09-27', '2004-10-05', '2004-10-01', 'In Process', NULL, 103, 'IMG_20130305_101143.jpg'),
...
(10312, '2004-10-21', '2004-10-27', '2004-10-23', 'Disputed', NULL, 124, ''),
...
(10325, '2004-11-05', '2004-11-13', '2004-11-08', 'Shipped', NULL, 121, 'Water lilies.jpg'),
...
(10345, '2004-11-25', '2004-12-01', '2004-11-26', 'Shipped', NULL, 103, 'Winter.jpg'),
(10346, '2004-11-29', '2004-12-05', '2004-11-30', 'Shipped', NULL, 112, 'Winter.jpg'),
...
(10425, '2005-05-31', '2005-06-07', NULL, 'In Process', NULL, 119, 'Blue hills.jpg');
...
CREATE TABLE IF NOT EXISTS `test` (
  ...
  `names` varchar(1111) NOT NULL,
  `emails` varchar(1111) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `test` (`id`, `names`, `emails`) VALUES
(2, 'sdfdsf&/]]  _  435 '''''' rewer$', 'test'),
(3, 'vivek', 'test'),
(4, 'space', 'test'),
(5, 'space', 'test'),
(6, 'space', 'test'),
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `longitude` varchar(1111) NOT NULL,
  `latitude` varchar(1111) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `users` (`id`, `username`, `password`, `longitude`, `latitude`) VALUES
(1, 'vivek', 'space', '78.449639985256', '17.43900073212409');
